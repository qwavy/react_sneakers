...
class Products {
    ...
    products = [
        ...
        {id:7,title:"UHUD CRAFTS Beautiful Antique Wooden",price:7,description:"Antique Foldable table, easy to carry anywhere. A perfect gift item for you.This multipurpose table can be used for any showpiece on it , plant stand and more.",category:"furniture",image:uhud_crafts_beautiful_antique,rating:{rate:4.9,count:8}, favourite:false, discount:45},
        {id:8,title:"Sketch Book Talens Art Creation",price:9,description:"High quality book protected by a hardback black casing with an elasticated strapSketch with pencil, charcoal, chalk, graphite, crayon, ink or watercolor",category:"office tools",image:sketch_book,rating:{rate:4.5,count:29}, favourite:false,  discount:50},
        {id:9,title:"Sakura Pigma Micron Pigment Fineliner Pens",price:19,description:"Single Black Pigma Fineliner Pen from Sakura.The durable 0.1mm porous-point nib delivers a consistent line as well as superb colour transferal.Sakura's unique PIGMA Ink is the first in the world to combine both water-based and pigment inks.",category:"office tools",image:sakura_pigma_micron_pigment,rating:{rate:4.9,count:44}, favourite:false, discount:60},
        {id:10,title:"15 Pcs Artist Paint Brush Set Holder Acrylic",price:14,description:"5PC ACRYLIC PIANT BRUSHES: Acrylic artist professional painting brushes contains 7 kinds of shapes (15pcs )in the package. they are flat, angular, filbert, round, fan, liner, comb. No matter for broad coloring, shaping, or detail delineating",category:"office tools",image:pcs_artist_paint_brush,rating:{rate:3.9,count:31}, favourite:false, discount:45},
        {id:11,title:"I Paused My Game to Be Here",price:29,description:"Gift ideas for birthday, Christmas or a present for any occasion; makes a nice present for your gamer husband, brother, nephew, grandson, friend or teenage son. A fun way to celebrate this special day",category:"clothes",image:hoodie,rating:{rate:4.7,count:88}, favourite:false, discount:10},
        {id:12,title:"Twitch Embroidered Glitch Snapback Grey",price:19,description:"Hand Wash OnlyGrey snapback with Twitch's classic Glitch logo. Sized traditionally with adjustable snap strap to fit all heads.",category:"clothes",image:cap,rating:{rate:4.5,count:12}, favourite:false, discount:5},
        {id:13,title:"Gesean Men's Novelty Color Block Pullover",price:29,description:"Occasion: Considerable for daily wear; Party; sports; lounging; hang-out; home wear. suitable for women/men/girls/boys/teens, comfortable and fashion.",category:"clothes",image:pullover,rating:{rate:4.3,count:33}, favourite:false, discount:10},
        {id:14,title:"STAR WORK C Shaped End Table",price:49,description:"Small Side Table for Living Room?With simple stylish design, the C shaped end table works well As beside desk, laptop table, sofa side table, under couch table, chairside table, TV tray for eating ,suitable for any decor of your room",category:"furniture",image:table,rating:{rate:4.1,count:32}, favourite:false, discount:10},
        {id:15,title:"Furniture Kart wrought iron Single Seater Swing Chair with Stand",price:199,description:"High-quality swing: hanging basket Swing Chair adds a fun lounge vibe to your Outdoor space. Constructed with durable black-brown faux Ratan Wicker and a sturdy iron frame, its easy to care for and built to last",category:"furniture",image:single_seater,rating:{rate:4.5,count:17}, favourite:false, discount:5},
        {id:16,title:"Lukzer Engineered Wood Coffee Center Tea Table 3 Tier Rack Sofa Side Table",price:99,description:"Made of particle board sheet, it is environmentally friendly, has strong texture and is not easy to be deformed, easy to clean, scratch resistant. Beautiful appearance, easy to install and use.",category:"furniture",image:tea_table,rating:{rate:4.4,count:31}, favourite:false, discount:10},
        {id:17,title:"Kusum Handicrafts Wooden 6 Seater Sofa Set for Living Room | 3+2+1 Seater Sofa",price:399,description:"Brand-Kusum HandicraftsMaterial: Sheesham WoodStyle: ModernSleek Contemporary Styling, This Sofa Set Features Clean Lines Which Will Make It An Elegant Addition To Any Existing Living Room, Office, Or Bedroom Decor.",category:"furniture",image:sofa,rating:{rate:4.0,count:20},favourite:false,discount:5},]
